    ...
    async def get_capabilities(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if not vis_params_list:
                ...
                return self._get_hardcoded_capabilities()
            ...
            "collections": [
                ...
                },
                {
                    ...
                    "visparam_details": [
                        ...
                        {"name": "landsat-tvi-agri", "display_name": "Agriculture", "description": "False color for vegetation"},
                        {"name": "landsat-tvi-false", "display_name": "False Color", "description": "Standard false color"}
                    ],
                    "months": ["01", "02", "03", "04", "05", "06", "07", "08", "09", "10", "11", "12"],
