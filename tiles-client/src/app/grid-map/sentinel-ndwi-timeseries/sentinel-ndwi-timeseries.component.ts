...
@Component({
    selector: 'app-sentinel-ndwi-timeseries',
    standalone: true,
    imports: [
        PlotlySharedModule,
        NgIf,
    ...
    templateUrl: './sentinel-ndwi-timeseries.component.html',
    styleUrl: './sentinel-ndwi-timeseries.component.scss'
})
export class SentinelNdwiTimeseriesComponent implements OnChanges, OnDestroy {
    ...
    constructor(private http: HttpClient) {
        this.loadSubject.pipe(
            ...
            switchMap(({lat, lon, method}) => {
                ...
                const url = `https://tiles.lapig.iesa.ufg.br/api/timeseries/ndwi/sentinel2/${lat}/${lon}`;
